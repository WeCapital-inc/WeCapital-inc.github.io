...
import Cat from '@site/src/components/Cat';
...
私はネットワークエンジニア出身ですが、ExPingなどのツールを使っていました。もう少し手軽にできるとよさそうだなと思い、Pingツールを作ってみました。[pro-bing](github.com/prometheus-community/pro-bing)というライブラリを使っていますがHTTPクライアントも対応しているようなので、HTTP対応してもいいかもしれません。
